...
func LoadStore(db dbm.DB, id types.CommitID, pruning types.PruningOptions, lazyLoading bool, startVersion int64) (types.CommitStore, error) {
	tree := iavl.NewMutableTree(db, defaultIAVLCacheSize, startVersion)
